...
/// Per-system → libretro-thumbnails GitHub subrepo. v1 covers the TG-16
/// trio; additional systems map here when their SystemId lands.
...
pub async fn sync_media_for_system(
    ...
    // Group entries by their target repo.
