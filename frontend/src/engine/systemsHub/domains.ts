...
export const DOMAINS: readonly DomainDef[] = [
  ...
  // Platform = facts about the console itself; Game = per-game facts for this
  // system's games. ("Platform" vs "System" terminology under review — see
  // PARKING_LOT 2026-06-14.)
  { id: "platform-metadata", label: "Platform Metadata", glyph: "✎", blurb: "Console facts · specs · hero · peripherals", enabled: true },
  { id: "game-metadata", label: "Game Metadata", glyph: "▦", blurb: "Per-game facts for this system's games", enabled: true },
